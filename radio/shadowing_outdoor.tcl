...
set tracefd	[open tr-files/shadowing_indoor_transparent.tr w]
...
set namtrace [open nam-files/shadowing_indoor_transparent.nam w]
$ns_ namtrace-all-wireless $namtrace $val(x) $val(y)

set prop [new $val(shadprop)]

$prop set pathlossExp_ 1.6
$prop set std_db_ 9.6
...
$ns_ at 0.1 "$node_(1) setdest 400.0 500.0 1000.0"
#$ns_ at 1.0 "$node_(1) setdest 500.0 500.0 1000.0"
#$ns_ at 0.1 "$node_(2) setdest 990.0 400.0 500.0"
