...
set tracefd	[open tr-files/shadowing_indoor_transparent_rand.tr w]
...
set namtrace [open nam-files/shadowing_indoor_transparent_rand.nam w]
$ns_ namtrace-all-wireless $namtrace $val(x) $val(y)

set prop [new $val(shadprop)]

$prop set pathlossExp_ 1.6
$prop set std_db_ 6.0
